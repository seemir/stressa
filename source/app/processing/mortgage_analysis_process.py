...
class MortgageAnalysisProcess(Process):
    ...
    def validate_mortgage(self):
        ...
        validate_mortgage_operation = ValidateMortgage(
        ...
        mortgage_signal = Signal(mortgage, "Validated Mortgage Information",
                                 prettify_keys=True,
                                 length=4)
    ...
    def fixed_stress_test(self):
        ...
        self.add_transition(mortgage_signal, fixed_stress_test_operation,
                            label="thread")
    ...
    def serial_stress_test(self):
        ...
        self.add_transition(mortgage_signal, serial_stress_test_operation,
                            label="thread")
    ...
    def extract_1(self):
        ...
        total_income_extract_operation = Extract(validated_mortgage.data,
                                                 "personinntekt_total_aar")
        self.add_node(total_income_extract_operation)
        self.add_transition(validated_mortgage, total_income_extract_operation,
                            label="thread")
    ...
    def extract_2(self):
        ...
        """
        validated_mortgage = self.get_signal("validated_mortgage")
        equity_extract_operation = Extract(validated_mortgage.data,
                                           "egenkapital")
        self.add_node(equity_extract_operation)
        self.add_transition(validated_mortgage, equity_extract_operation,
                            label="thread")
    ...
    def extract_3(self):
        ...
        """
        validated_mortgage = self.get_signal("validated_mortgage")
        repayment_ability_extract_operation = Extract(validated_mortgage.data,
                                                      "betjeningsevne")
        self.add_node(repayment_ability_extract_operation)
        self.add_transition(validated_mortgage, repayment_ability_extract_operation,
                            label="thread")
    ...
    def extract_4(self):
        ...
        """
        validated_mortgage = self.get_signal("validated_mortgage")
        period_extract_operation = Extract(validated_mortgage.data,
                                           "laneperiode")
        self.add_node(period_extract_operation)
        self.add_transition(validated_mortgage, period_extract_operation,
                            label="thread")
    ...
    def extract_5(self):
        ...
        """
        validated_mortgage = self.get_signal("validated_mortgage")
        interval_extract_operation = Extract(validated_mortgage.data,
                                             "intervall")
        self.add_node(interval_extract_operation)
        self.add_transition(validated_mortgage, interval_extract_operation,
                            label="thread")
    ...
    def extract_6(self):
        ...
        """
        validated_mortgage = self.get_signal("validated_mortgage")
        start_date_extract_operation = Extract(validated_mortgage.data,
                                               "startdato")
        self.add_node(start_date_extract_operation)
        self.add_transition(validated_mortgage, start_date_extract_operation,
                            label="thread")
    ...
    def multiply_1(self):
        ...
        mortgage_limit_operation = Multiplication(
            {'belaning': self.get_signal("arsinntekt_aar").data[
                'arsinntekt_aar']},
    ...
    def extract_7(self):
        ...
        extract_mortgage_limit_operation = Extract(mortgage_limit.data,
                                                   "belaning")
        ...
        extract_mortgage_limit['krav_belaning'] = extract_mortgage_limit.pop(
            'belaning')

        extract_mortgage_signal = Signal(extract_mortgage_limit,
                                         "Required Mortgage Limit")

        self.add_signal(extract_mortgage_signal, "krav_belaning")
        self.add_transition(extract_mortgage_limit_operation,
                            extract_mortgage_signal,
                            label="thread")
    ...
    def fixed_mortgage_payment_plan(self):
        ...
        self.add_transition(interest, fixed_payment_plan_operation,
                            label="thread")
    ...
    def series_mortgage_payment_plan(self):
        ...
        self.add_transition(interest, series_payment_plan_operation,
                            label="thread")
    ...
    def output_operation(self):
        ...
        output_signal = OutputSignal(mortgage_information.data,
                                     desc="Multiplexed Mortgage Information",
                                     prettify_keys=True,
                                     length=4)
