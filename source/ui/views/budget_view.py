...
class BudgetView(QDialog):
    ...
    def __init__(self, parent: QWidget):
        ...
        self._parent = parent
        self.ui_form = loadUi(
            os.path.join(os.path.dirname(__file__), "forms/budget_form.ui"),
            self)
        ...
        self.ui_form.push_button_budget_meta_data_1.clicked.connect(
        ...
        self.ui_form.push_button_budget_meta_data_2.clicked.connect(
            self.meta_view.display)
    ...
    def export(self):
        ...
        """
        self.parent.mortgage_model.set_line_edits("",
                                                  self.budget_model.total_posts,
    ...
    def clear_all(self):
        ...
        """
        self.parent.mortgage_model.clear_line_edits(
            self.budget_model.total_posts)
        for combo_box in range(1, 23):
            getattr(self.ui_form,
                    "combo_box_interval_" + str(combo_box)).setCurrentIndex(0)
