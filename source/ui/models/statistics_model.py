...
class StatisticsModel(Model):  # pylint: disable=too-many-instance-attributes
    ...
    _community_charts = ["age_distribution_city_area", "age_distribution_city",
                         "civil_status_city_area", "civil_status_city", "education_city_area",
                         "education_city", "income_city_area", "income_city",
                         "family_composition_city_area", "family_composition_city",
